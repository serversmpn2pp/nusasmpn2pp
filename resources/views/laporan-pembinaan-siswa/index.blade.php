        ...
        @if ($bolehLapor || $bolehPusatVerifikasi)
            <div class="report-header-actions">
                @if ($bolehPusatVerifikasi)
                    <a href="{{ route('pusat-verifikasi-pelanggaran.index') }}" class="button button-dark">Pemeriksaan & Pengesahan</a>
                @endif
                @if ($bolehCatatPembinaan)
                    <a href="{{ route('laporan-pembinaan-siswa.create', ['jenis' => 'pembinaan']) }}" class="button button-muted">Catat pembinaan langsung</a>
                @endif
                @if ($bolehLapor)
