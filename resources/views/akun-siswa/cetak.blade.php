...
<head>
    ...
    <title>Daftar Akun Siswa {{ $kelas->nama }} - NUSA</title>
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .sheet-head h1{font-family:Georgia,serif;font-size:15pt;letter-spacing:0;margin:0;text-transform:uppercase}
        .sheet-head h2{color:var(--primary);font-size:12pt;letter-spacing:0;margin:2px 0}
        ...
        .credentials{border-collapse:collapse;font-size:8.5pt;width:100%}
        ...
        .credentials .password{font-size:9.5pt;font-weight:800;letter-spacing:1px}
...
<body>
    <div class="print-toolbar">
        <strong>Daftar akun {{ $kelas->nama }} siap dicetak</strong>
    ...
    <main class="sheet">
            ...
            <tbody>
                @forelse ($anggotaKelas as $anggota)
                    ...
                    <tr>
                        ...
                        <td class="number">{{ $siswa?->nis ?: '-' }}</td>
                        <td class="number">{{ $akun?->username ?: ($siswa?->nisn ?: '-') }}</td>
                        <td class="password">
                        ...
                        <td>
                            ...
                            @elseif (! $siswa?->nisn)
                                <span class="muted">NISN kosong</span>
                            @else
                                <span class="muted">Belum ada akun</span>
                            @endif
                        </td>
                    </tr>
                @empty
        ...
        <div class="notice">
            <strong>Rahasia.</strong> Bagikan setiap username dan password hanya kepada siswa yang bersangkutan.
            Siswa wajib mengganti password awal setelah login pertama. Setelah diganti, password tidak dapat dilihat kembali dan hanya dapat direset oleh administrator.
        </div>
