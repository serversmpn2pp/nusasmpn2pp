...
IconData nusaMenuEntryIcon(MenuEntry item) {
  return switch (item.code) {
    ...
    'jadwal-pelajaran-anak' => Icons.calendar_view_week_rounded,
    'nilai-anak-saya' => Icons.workspace_premium_rounded,
    ...
    'kehadiran-anak-saya' => Icons.family_restroom_rounded,
    'ibadah-saya' => Icons.self_improvement_rounded,
    'ibadah-anak-saya' => Icons.volunteer_activism_rounded,
    ...
    'rekap-berhalangan-ibadah' => Icons.shield_outlined,
    'scan-ibadah-siswa' ||
    ...
    'progress-kasus-saya' => Icons.route_rounded,
    'pembinaan-poin-anak' => Icons.family_restroom_rounded,
    ...
    'penugasan-guru-bk-tingkat' => Icons.manage_accounts_rounded,
    'siswa-wali-saya' => Icons.supervised_user_circle_rounded,
    'laporan-siswa-wali' => Icons.assignment_ind_rounded,
