...
abstract interface class MySurveyResultsRemoteDataSource {
...
final class DioMySurveyResultsRemoteDataSource
    implements MySurveyResultsRemoteDataSource {
  DioMySurveyResultsRemoteDataSource(this._dio);
  ...
  Future<SurveyMonitoringDetail> fetchDetail({
    ...
    try {
      final response = await _dio.get<Map<String, dynamic>>(
        'hasil-survei-saya/$assignmentId',
...
final mySurveyResultsRemoteDataSourceProvider =
    Provider<MySurveyResultsRemoteDataSource>(
      (ref) => DioMySurveyResultsRemoteDataSource(ref.watch(dioProvider)),
    );
