...
class PermissionRouteTest extends TestCase
{
    ...
    public function test_route_absensi_dan_bk_memakai_permission_modul(): void
    {
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.pelaksanaan-sanksi-siswa.show', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.pelaksanaan-sanksi-siswa.update', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.pelaksanaan-sanksi-siswa.bukti.store', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.pelaksanaan-sanksi-siswa.bukti.destroy', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-saya.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-saya.index', 'izin:poin_siswa.lapor');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-kelas.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-kelas.index', 'izin:poin_siswa.lihat');
    ...
    public function test_route_cbt_memakai_permission_cbt(): void
    {
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.ujian-terpusat.jadwal.store', 'izin:cbt.panitia,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.ujian-terpusat.jadwal.update', 'izin:cbt.panitia,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.ujian-terpusat.jadwal.destroy', 'izin:cbt.panitia,cbt.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.hasil-ujian-terpusat.koreksi-uraian', 'izin:cbt.soal_kelola,cbt.panitia,cbt.terpusat_lihat,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.hasil-ujian-terpusat.koreksi-uraian.update', 'izin:cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.hasil-ujian-terpusat.finalisasi', 'izin:cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.hasil-ujian-terpusat.finalisasi.destroy', 'izin:cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.hasil-ujian-terpusat.publikasi', 'izin:cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.hasil-ujian-terpusat.publikasi.destroy', 'izin:cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.hasil-ujian-terpusat.terapkan-nilai', 'izin:cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.presensi-ujian.index', 'izin:cbt.presensi,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.presensi-ujian.show', 'izin:cbt.presensi,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.presensi-ujian.scan', 'izin:cbt.presensi,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.presensi-ujian.manual', 'izin:cbt.presensi,cbt.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('ujian-cbt.hasil.finalisasi', 'izin:cbt.soal_kelola,cbt.kelola');
    ...
    public function test_route_master_inventaris_memakai_permission_barang(): void
    {
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.dashboard-sarpras', 'izin:barang.lihat,barang.kelola,barang.peminjaman_kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.barang.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.barang.show', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.barang.store', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.barang.update', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.barang.destroy', 'izin:barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.kategori-barang.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.kategori-barang.store', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.kategori-barang.update', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.kategori-barang.destroy', 'izin:barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.satuan-barang.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.satuan-barang.store', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.satuan-barang.update', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.satuan-barang.destroy', 'izin:barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.lokasi-barang.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.lokasi-barang.store', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.lokasi-barang.update', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.lokasi-barang.destroy', 'izin:barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-inventaris.show', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-inventaris.update', 'izin:barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.sumber-perolehan.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.sumber-perolehan.store', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.sumber-perolehan.update', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.sumber-perolehan.destroy', 'izin:barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.barang-datang.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.barang-datang.show', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.barang-datang.store', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.barang-datang.batalkan', 'izin:barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.unit-aset.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.unit-aset.show', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.unit-aset.store', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.unit-aset.update', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.unit-aset.destroy', 'izin:barang.kelola');
        $this->assertRouteMemakaiMiddleware('label-barcode-inventaris.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.label-inventaris', 'izin:barang.lihat,barang.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.saldo-stok', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.mutasi-stok.index', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.mutasi-stok.show', 'izin:barang.lihat,barang.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.mutasi-stok.store', 'izin:barang.kelola');
