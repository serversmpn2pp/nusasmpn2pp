...
class PermissionRouteTest extends TestCase
{
    ...
    public function test_route_absensi_dan_bk_memakai_permission_modul(): void
    {
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.rekap-presensi-siswa.pesan-whatsapp', 'izin:absensi.lihat,absensi.koreksi,absensi.koreksi_hari_ini,absensi.laporan');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-presensi-pegawai.index', 'izin:absensi.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-presensi-pegawai.store', 'izin:absensi.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-presensi-pegawai.update', 'izin:absensi.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.status-scan-presensi-pegawai.index', 'izin:absensi.scan,absensi.lihat,absensi.koreksi,absensi.laporan');
        $this->assertRouteMemakaiMiddleware('api.v1.rekap-presensi-pegawai.index', 'izin:absensi.lihat,absensi.koreksi,absensi.laporan,absensi_pegawai.pribadi');
        $this->assertRouteMemakaiMiddleware('api.v1.rekap-presensi-pegawai.show', 'izin:absensi.lihat,absensi.koreksi,absensi.laporan,absensi_pegawai.pribadi');
        $this->assertRouteMemakaiMiddleware('api.v1.rekap-presensi-pegawai.update', 'izin:absensi.koreksi');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-presensi-pegawai.index', 'izin:absensi.laporan,absensi_pegawai.pribadi');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-presensi-pegawai.show', 'izin:absensi.laporan,absensi_pegawai.pribadi');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.kegiatan-ibadah.index', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.kegiatan-ibadah.store', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.kegiatan-ibadah.update', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.kegiatan-ibadah.destroy', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.jadwal-kegiatan-ibadah.index', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.jadwal-kegiatan-ibadah.store', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.jadwal-kegiatan-ibadah.update', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.jadwal-kegiatan-ibadah.destroy', 'izin:ibadah.pengaturan_kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-berhalangan-ibadah.index', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-berhalangan-ibadah.update', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-berhalangan-ibadah.pendamping.store', 'izin:ibadah.pengaturan_kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-berhalangan-ibadah.pendamping.destroy', 'izin:ibadah.pengaturan_kelola');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.scan-kegiatan-ibadah.index', 'izin:ibadah.scan');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.aturan-sanksi-poin.index', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.aturan-sanksi-poin.store', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.aturan-sanksi-poin.update', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.aturan-sanksi-poin.destroy', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-poin-keterlambatan.index', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-poin-keterlambatan.update', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-peringatan-dini-poin.index', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-peringatan-dini-poin.update', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-batas-proses-pelanggaran.index', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.pengaturan-batas-proses-pelanggaran.update', 'izin:poin_siswa.pengaturan');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.laporkan-kejadian.referensi', 'izin:poin_siswa.lapor');
        $this->assertRouteMemakaiMiddleware('api.v1.laporkan-kejadian.referensi', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporkan-kejadian.store', 'izin:poin_siswa.lapor');
        $this->assertRouteMemakaiMiddleware('api.v1.laporkan-kejadian.store', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa.index', 'izin:bk.lihat,bk.kelola,poin_siswa.lapor,poin_siswa.lihat,poin_siswa.verifikasi_bk,poin_siswa.sahkan_wakil');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa.show', 'izin:bk.lihat,bk.kelola,poin_siswa.lapor,poin_siswa.lihat,poin_siswa.verifikasi_bk,poin_siswa.sahkan_wakil');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa.show', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa.bukti', 'izin:bk.lihat,bk.kelola,poin_siswa.lapor,poin_siswa.lihat,poin_siswa.verifikasi_bk,poin_siswa.sahkan_wakil');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa.bukti', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.pemeriksaan-pengesahan.index', 'izin:poin_siswa.lihat,poin_siswa.verifikasi_bk,poin_siswa.sahkan_wakil');
        $this->assertRouteMemakaiMiddleware('api.v1.pemeriksaan-pengesahan.index', 'akun_pegawai');
        ...
        $this->assertRouteMemakaiMiddleware('api.v1.peringatan-dini-siswa.index', 'izin:poin_siswa.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.peringatan-dini-siswa.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.peringatan-dini-siswa.show', 'izin:poin_siswa.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.peringatan-dini-siswa.proses', 'izin:poin_siswa.pengaturan');
        $this->assertRouteMemakaiMiddleware('api.v1.rekap-poin-siswa.index', 'izin:poin_siswa.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.rekap-poin-siswa.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.rekap-poin-siswa.show', 'izin:poin_siswa.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.penugasan-guru-wali.index', 'izin:guru_wali.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.penugasan-guru-wali.store', 'izin:guru_wali.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.penugasan-guru-wali.destroy', 'izin:guru_wali.kelola');
        $this->assertRouteMemakaiMiddleware('api.v1.siswa-wali-saya.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.siswa-wali-saya.index', 'izin:guru_wali.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.siswa-wali-saya.show', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.siswa-wali-saya.show', 'izin:guru_wali.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-wali.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-wali.index', 'izin:guru_wali.lihat,poin_siswa.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-wali.show', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-wali.show', 'izin:guru_wali.lihat,poin_siswa.lihat');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-wali.bukti', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('api.v1.laporan-siswa-wali.bukti', 'izin:guru_wali.lihat,poin_siswa.lihat');
    ...
    public function test_route_cbt_memakai_permission_cbt(): void
    {
        ...
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.update', 'izin:cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.destroy', 'izin:cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.panitia.store', 'izin:cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.panitia.destroy', 'izin:cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.sesi.store', 'izin:cbt.panitia,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.sesi.update', 'izin:cbt.panitia,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.sesi.destroy', 'izin:cbt.panitia,cbt.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.jadwal.destroy', 'izin:cbt.panitia,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.pengawas.update', 'izin:cbt.panitia,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-terpusat.pengawas.ganti', 'izin:cbt.panitia,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('tugas-pengawas-ujian.index', 'akun_pegawai');
        $this->assertRouteMemakaiMiddleware('tugas-pengawas-ujian.periksa', 'izin:cbt.panitia,cbt.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('ujian-cbt.soal.edit', 'izin:cbt.asesmen_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-cbt.soal.edit', 'akses_ujian_cbt');
        $this->assertRouteMemakaiMiddleware('ujian-cbt.soal.update', 'izin:cbt.asesmen_kelola,cbt.kelola');
        ...
        $this->assertRouteMemakaiMiddleware('ujian-cbt.koreksi-manual.index', 'izin:cbt.asesmen_kelola,cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-cbt.koreksi-manual.update', 'izin:cbt.asesmen_kelola,cbt.soal_kelola,cbt.kelola');
        $this->assertRouteMemakaiMiddleware('ujian-cbt.terapkan-nilai.store', 'izin:cbt.asesmen_kelola,cbt.soal_kelola,cbt.kelola');
