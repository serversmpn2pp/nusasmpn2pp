...
class PresentasiProgressKasusService
{
    public function status(LaporanPembinaanSiswa $laporan): array
    {
    ...
    public function linimasaPublik(LaporanPembinaanSiswa $laporan): Collection
    {
        $linimasa = collect();
