...
class ProsesScanAbsensi
{
    ...
    public function proses(
        ...
        if ($this->scanDuplikatCepat($parsed['nisn'], $waktuScan)) {
            return $this->gagal(
                isiScan: $isiScan,
                waktuScan: $waktuScan,
                statusScan: 'duplikat_cepat',
                pesan: 'Scan sudah diterima beberapa detik lalu.',
                scannerId: $parsed['scanner_id'],
                nisn: $parsed['nisn'],
                jenisScan: $jenisScanDiminta,
                siswa: $siswa,
        ...
        return DB::transaction(function () use ($isiScan, $parsed, $waktuScan, $siswa, $tahunPelajaran, $anggotaKelas, $pengaturanAbsensi, $ipAddress, $userAgent) {
            ...
            if ($absensi->jam_masuk) {
                return $this->gagal(
                    ...
                    pesan: 'Siswa sudah melakukan scan masuk.',
                    scannerId: $parsed['scanner_id'],
                    nisn: $parsed['nisn'],
                    jenisScan: 'masuk',
                    siswa: $siswa,
        ...
        return DB::transaction(function () use ($isiScan, $parsed, $waktuScan, $siswa, $tahunPelajaran, $anggotaKelas, $pengaturanAbsensi, $ipAddress, $userAgent) {
            ...
            if ($absensi->jam_pulang) {
                return $this->gagal(
                    ...
                    pesan: 'Siswa sudah melakukan scan pulang.',
                    scannerId: $parsed['scanner_id'],
                    nisn: $parsed['nisn'],
                    jenisScan: 'pulang',
                    siswa: $siswa,
    ...
    private function scanDuplikatCepat(string $nisn, CarbonInterface $waktuScan): bool
    {
