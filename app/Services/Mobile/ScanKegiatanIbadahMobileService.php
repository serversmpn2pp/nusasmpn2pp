...
class ScanKegiatanIbadahMobileService
{
    ...
    public function dashboard(Pengguna $pengguna, ?int $jadwalId = null, ?CarbonInterface $waktu = null): array
    {
        ...
        return [
            ...
            'presensi_terbaru' => $presensiTerbaru
                ->map(fn (PresensiKegiatanIbadah $presensi) => $this->dataPresensi($presensi))
                ->values(),
        ];
    }
    ...
    private function statusJadwal(?JadwalKegiatanIbadah $jadwal, CarbonInterface $waktu): array
    {
        ...
        return [
            'kode' => 'aktif',
            'label' => 'Scan aktif',
            'pesan' => 'Kamera siap digunakan untuk presensi siswa.',
        ];
    }
