...
class RingkasanNilaiSiswaService
{
    public function siapkan(
        ?Siswa $siswa,
        ?int $tahunPelajaranDiminta = null,
        ?string $semesterDiminta = null,
    ): array {
        ...
        $tahunPelajaranId = (int) ($tahunPelajaranDiminta ?: $tahunPelajaranAktif?->id);
        $semester = $semesterDiminta ?: $this->semesterSaatIni();
        ...
        return [
            ...
            'tahunPelajaranDipilih' => $tahunPelajaranDipilih,
