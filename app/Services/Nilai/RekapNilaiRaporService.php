...
class RekapNilaiRaporService
{
    public function hitung(int|string|null $guruMataPelajaranId, string $semester = 'ganjil'): array
    {
        ...
        if ($guruMataPelajaranId) {
            ...
            $komponenNilai = $this->ambilKomponenNilai(
                $guruMataPelajaranDipilih->id,
                $semester,
                $anggotaKelas->pluck('siswa_id'),
            );
            $jumlahKomponen = $this->hitungJumlahKomponen($komponenNilai);
            $rekapNilai = $this->hitungRekapNilai(
                $anggotaKelas,
                $komponenNilai,
                $jumlahKomponen,
                $skemaBobotNilai,
    ...
    private function ambilAnggotaKelas(int $kelasId): Collection
    {
    ...
    private function ambilKomponenNilai(int $guruMataPelajaranId, string $semester, Collection $siswaIds): Collection
    {
    ...
    private function hitungJumlahKomponen(Collection $komponenNilai): array
    {
    ...
    private function hitungRekapNilai(
        Collection $anggotaKelas,
        Collection $komponenNilai,
        ...
        return $anggotaKelas->map(function (AnggotaKelas $anggota) use ($nilaiPerSiswa, $jumlahKomponen, $skemaBobotNilai, $bobot) {
            ...
            return [
                ...
                'kategori' => $kategori,
                'nilai_akhir' => $lengkap ? $this->hitungNilaiAkhir($kategori) : null,
                'lengkap' => $lengkap,
