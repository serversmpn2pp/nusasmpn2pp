...
class LaporanSiswaKelasController extends Controller
{
    public function index(Request $request, LaporanSiswaMobileService $service): JsonResponse
    {
        return $this->tanpaCache([
            'data' => $service->daftarKelasSaya($request->user(), $this->validasiFilter($request)),
        ]);
    }
    ...
    public function show(
        ...
        return $this->tanpaCache([
            'data' => $service->rincianKelasSaya($request->user(), $laporanPembinaanSiswa),
        ]);
    }
    ...
    public function evidence(
        ...
        $service->pastikanLaporanKelasSaya(
            $request->user(),
